...
import { Search, Send, ArrowLeft, Check, CheckCheck, Eye, Shield } from 'lucide-react';
...
const DoctorMessages = () => {
  ...
  return (
    <DoctorLayout>
      <div className="h-[calc(100vh-2rem)] flex bg-background rounded-lg border overflow-hidden">
        {/* Patient List */}
        ...
        <div className={`flex-1 flex flex-col ${!selectedPatient ? 'hidden md:flex' : 'flex'}`}>
          {selectedPatient ? (
            <>
              ...
              {/* Medical Access Request in Chat */}
